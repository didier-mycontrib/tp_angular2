System.register(['@angular/core', '@angular/router', './welcome.component', './identification.component'], function(exports_1, context_1) {
    "use strict";
    ...
    var core_1, router_1, welcome_component_1, identification_component_1;
    ...
    return {
        ...
        execute: function() {
            routes = [
                ...
                { path: 'identification', component: identification_component_1.IdentificationComponent }
            ];
