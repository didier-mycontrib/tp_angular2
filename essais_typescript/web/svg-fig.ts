...
class Line  extends Fig2D{
  ...
  performVisit(visitor : FigVisitor) : void { visitor.doActionForLine(this); }
}
...
class Circle  extends Fig2D{
  ...
  performVisit(visitor : FigVisitor) : void { visitor.doActionForCircle(this); }
}
...
class Rectangle  extends Fig2D{
  ...
  performVisit(visitor : FigVisitor) : void { visitor.doActionForRectangle(this); }
}
